...
type FactoryOpts struct {
	...
	Grpc11Opts   *grpc11.GRPC11Opts `mapstructure:"GRPC11,omitempty" json:"GRPC11,omitempty" yaml:"GRPC11"`
}
...
func setFactories(config *FactoryOpts) error {
	...
	// Remote-PKCS11-Based BCCSP
	if config.Grpc11Opts != nil {
		f := &GRPC11Factory{}
		err := initBCCSP(f, config)
		if err != nil {
			factoriesInitError = fmt.Errorf("Failed initializing GRPC11.BCCSP %s\n[%s]", factoriesInitError, err)
		}
	}
